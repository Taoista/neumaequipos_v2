                    ...
                    <div class="product_d_right">
                       <form action="#">
                            ...
                            <div class="price_box">
                                ...
                                <span class="current_price"><?php echo fomato_moneda($datos_pack["p_oferta"]); ?></span>
                            ...
                            <div class="product_desc">
                                <?php for ($i=0; $i < count($productos) ; $i++) { ?>
                                    <p><a href="<?php echo  _Url.'producto/'.$productos[$i]["id"].'/'.$productos[$i]["nombre"]; ?>"> <?php echo $productos[$i]["nombre"]; ?></a></p>
                                <?php } ?>
                            </div>
