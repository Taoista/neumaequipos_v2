                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/desmontadoras/104780.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/desmontadoras/104780.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=104780">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Desmontadora camión bus PL-2900 </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10">
                                    	Desmontadora para camiones 14 – 26” marca PULI, procedencia china. Diámetro máximo rueda 1600 mm, Ancho máximo rueda 780 mm, Peso máximo de rueda 1000 kg. Motor caja reductora 1.5 kw Motor de bomba hidráulica 1.1 kw.
 </p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 104780</h3>
                                </div>
                          ...
                          <ul class="nav nav-tabs ">
                            ...
                            <div class="tab-content">
                             ...
                             <!--            <tr>
                                        ...
                                        <tr>
                                            <td>Diámetro máximo rueda</td>
                                            <td>1600mm</td>
                                        </tr>
                                        <tr>
                                           <td>Ancho máximo rueda</td>
                                            <td>780mm </td>
                                        </tr>
                                        <tr>
                                            <td>Peso máximo de rueda</td>
                                            <td>1000kg</td>
                                        </tr>
                                        <tr>
                                            <td>Motor caja reductora</td>
                                            <td>1.5 KW</td>
                                        </tr>
                                        <tr>
                                            <td>Motor de bomba hidráulica 1.1 kw</td>
                                            <td>1.1 kw</td>
                                        </tr>
