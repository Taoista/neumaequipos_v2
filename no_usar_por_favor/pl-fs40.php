        ...
        <div class="dlab-bnr-inr overlay-black-middle" style="background-image:url(images/2.0/elevadoras/banner_elevadores.png);">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">Detalle Elevadores</h1>
                </div>
            </div>
        </div>
                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/elevadoras/105325.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/elevadoras/105325.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=105325">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Elevador 4 columnas alineación PULI PL-FS40  </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">Elevador electro hidráulico, cuatro columnas para un peso Máximo de hasta 4,0 Ton. Ideal para trabajos de alineación, inspección y reparación tanto de tren delantero (por gato central), carrocería, caños de escapes como cambio de aceite y mecánica en general. Sus plataformas permiten el acceso de todo tipo de vehículos. </p><p align="justify">Bastidor de seguridad instalado en cada columna.</p><p align="justify">La anchura ajustable entre dos plataformas hace que el ascensor más flexible para diferentes vehículos.
 </p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105325</h3>
                                </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="graphic-design-1" class="tab-pane active">
                                    <table class="table table-bordered" >*
                                            ...
                                            *Ancho Total                           3097mm.
                                            *Largo plataforma                    5415mm.
                                            *Ancho pasillo                         90mm.
                                            *Ancho plataforma                   50,8mm.
                                            *Incluye Rolling Jack hidráulico (gato central)
