                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/elevadoras/105327.jpg" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/elevadoras/105327.jpg">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=105327">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Elevador Tijera bajo piso PL-30</a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p align="justify">PL-E30 Elevador de tijera pequeño de altura. Es un elevador de tijera empotrado con capacidad de elevación de 3000 KG (6,614 lb).</p><p align="justify"> Altura mínima de 330 mm, altura de elevación de 2050 mm. </p><p align="justify">Sistema de bloqueo neumático de seguridad.</p><p align="justify"> Protección contra sobretensiones. </p><p align="justify">Plataforma duradera de una pieza.</p>
		                     <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105327</h3>
                                </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="graphic-design-1" class="tab-pane active">
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            <td>PESO MAXIMO DE TRABAJO</td>
                                            <td>3000KG</td>
                                        </tr>
                                        <tr>
                                           <td>ALTURA MAXIMA TRABAJO</td>
                                            <td>2050MM</td>
                                        </tr>
                                        <tr>
                                            <td>ALTURA MINIMA</td>
