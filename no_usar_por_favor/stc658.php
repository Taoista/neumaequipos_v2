                            ...
                            <form method="post" class="cart" action="contacto.php?dato=105356">
                                <div class="dlab-post-title ">
                                    ...
                                    <p class="m-b10" align="justify">
                                    	Desmontadora para auto/camioneta semi automática, fácil de manipular e ideal para iniciar en el rubro de vulcanización, también para iniciar en talleres de cambio de neumáticos o ventas de llantas.</p><p align="justify">
                                        *Desmontadora semi automática </p><p align="justify">
...
*Alimentación eléctrica: 220 volts. </p><p align="justify">
*Presión de servicio 8-10 bar. </p><p align="justify">
*Velocidad de rotación 8 Rpm. </p><p align="justify">
*Peso del equipo  170 Kg
                                    ...
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105356</h3>
                                </div>
