                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/compresores/105009.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Compresor Piston" href="images/2.0/compresores/105009.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=105009">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Compresor  EMAX TD-2050B</a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">Válvula de seguridad de sobre-presión.</p><p align="justify">Incluye dos ruedas y pata de soporte, manilla para fácil traslado ademas de una válvula para drenaje de estanque, con Carter lubricado.</p><p align="justify"> Presostato automático ON/OFF.</p><p align="justify">Protección de seguridad de plástico.</p><p align="justify">Seguridad eléctrica comprobada en un 100%</p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105009</h3>
                                </div>
