                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/desmontadoras/104145.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/desmontadoras/104145.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=104145">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Desmontadora STC868R Sunshine </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">Desmontadora Automática, capacidad aro interno 13 - 24", capacidad aro externo 11" - 22", fuerza destalonador 2500kg. Alimentación eléctrica 220v.</p><p align="justify"> Presión de servicio 8-10 bar. Velocidad de rotación 8Rpm. Peso del equipo 270kg Incluye estanque acumulador TI.
 </p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 104145</h3>
                                </div>
                        ...
                        <div class="dlab-tabs product-description border-tp bg-tabs tabs-site-button">
                            ...
                            <div class="tab-content">
                             ...
                             <!--            <tr>
                                        ...
                                        <tr>
                                            <td>Incluye estanque acumulador</td>
                                            <td>TI</td>
                                        </tr>
