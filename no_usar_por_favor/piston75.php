                ...
                <div class="row m-b30">
                    <div class="col-lg-5 col-md-5">
                        <div class="product-gallery on-show-slider">
                            <div id="sync1" class="owl-carousel owl-theme owl-btn-center-lr m-b5 owl-btn-1 primary">
                                <div class="item">
                                    <div class="mfp-gallery agotado">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/compresores/105394.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Compresor Piston" href="images/2.0/compresores/105394.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=105394">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">COMPRESOR PISTON 7.5 HP 380V. TB75350</a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">Compresor de correa de 7.5HP con tanque de 350 L</p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105394</h3>
                                </div>
                           ...
                           <div class="tab-content">
                                ...
                                <div id="graphic-design-1" class="tab-pane active">
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            <td>Presión laboral</td>
                                            <td> 10-12Bar/145-175psi </td>
                                        </tr>
                                        <tr>
                                            <td>Tanque</td>
                                            <td>350 Lts</td>
