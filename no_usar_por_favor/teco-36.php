                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/desmontadoras/104031.jpg" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/desmontadoras/104031.jpg">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=104031">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">DESMONTADORA TECO 36</a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">Desmontadora automática concebida para los profesionales del sector e ideal para operar sobre ruedas de turismo y furgonetas de llanta 10" a 25".</p><p align="justify"> Tiene una particular robustez y fiabilidad, y pedales extraíbles a cajón para facilitar las operaciones de mantención.</p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 104031</h3>
                                </div>
                           ...
                           <ul class="nav nav-tabs ">
                            ...
                            <div class="tab-content">
                             ...
                             <!--            <tr>
                                        ...
                                        <tr>
                                            <td>Capacidad aro interno </td>
                                            <td> 13"-25".</td>
                                        </tr>
                                        <tr>
                                           <td>Capacidad aro externo</td>
                                            <td>10"-22" </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Ancho neumático</td>
                                            <td>370mm (14,5")</td>
                                        </tr>
                                        <tr>
                                            <td>Fuerza destalonador</td>
                                            <td>2.900 kg</td>
                                        </tr>
                                        <tr>
                                            <td>Incluye estanque acumulador (TI).</td>
                                            <td>Brazo Opcional para perfiles bajo.</td>
