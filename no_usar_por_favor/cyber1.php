        ...
        <div class="breadcrumb-row">
            <div class="container">
                <ul class="list-inline">
                    ...
                    <li>Detalle CYBER DAY OFERTA 1</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb row END -->
                ...
                <div class="row m-b30">
                            ...
                            <div id="sync1" class="owl-carousel owl-theme owl-btn-center-lr m-b5 owl-btn-1 primary">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/cyber/104035.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="1" href="images/2.0/cyber/104035.png">
                                ...
                                <div class="item">
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/cyber/104030.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/cyber/104030.png">
                                                            <i class="ti-fullscreen"></i>
                                                        </a>
                                                  </div>
                                                </div>
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=CYBERDAY_TECO">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">CYBER DAY OFERTA TECO </a></h2>
									<p align="justify">BALANCEADORA TECO 60</p>
									<p align="justify">DESMONTADORA TECO 27TI</p>
                                    ...
                                    <div class="relative">
                                    <h3 class="m-tb10">valor $2.800.000 + iva.</h3>
                                </div>
                        ...
                        <div class="dlab-tabs product-description border-tp bg-tabs tabs-site-button">
                          <ul class="nav nav-tabs ">
                            <li class="nav-item"><a data-toggle="tab" class="nav-link active" href="#prod1">
                                    <i class="fa fa-photo"></i>BALANCEADORA TECO 60</a></li>
                            ...
                            <div class="tab-content">
                            	...
                            	<div id="prod2" class="tab-pane">
                            		<p class="m-b10" align="justify">
                                        Desmontadora semi automática para Neumáticos de auto y camionetas desde aro 10" hasta aro 23". </p><p align="justify"> 
