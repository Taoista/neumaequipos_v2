                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/desmontadoras/104156.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/desmontadoras/104156.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=104156">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Brazo auxiliar para desmontador </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">Peso neto UPH 66KG. Peso neto UPH + BPS 72KG. Peso neto UPH + KIT PAX 98kg. Presión de servicio 7-10 bar

 </p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 104156</h3>
                                </div>
                           ...
                           <ul class="nav nav-tabs ">
                            ...
                            <div class="tab-content">
                                <div id="web-design-1" class="tab-pane active">
                                    <p class="m-b10"> <ul class="list-check-circle primary">Brazo auxiliar para desmontador </a></h2>
                                    <p class="m-b10">
                                    	Peso neto UPH 66KG
                                    	Peso neto UPH  + BPS 72KG
                                    	Peso neto UPH + KIT PAX 98kg
                                    	Presión de servicio 7-10 bar
 </p></ul>
                             ...
                             <!--            <tr>
                                        ...
                                        <tr>
                                            <td>Peso Neto 66kg</td>
                                            <td>22"</td>
                                        </tr>
                                        <tr>
                                           <td>Peso neto UPH  + BPS</td>
                                            <td>72kg </td>
                                        </tr>
                                        <tr>
                                            <td>Peso neto UPH + KIT PAX</td>
                                            <td>98KG</td>
                                        </tr>
                                        <tr>
