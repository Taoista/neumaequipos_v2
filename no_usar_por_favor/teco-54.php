                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/desmontadoras/104054.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/desmontadoras/104054.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=104054">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Desmontadora camión TECO 54  </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10">
                                    	Desmontadora electro-hidráulica para ruedas con y sin cámara de aire de camiones y autobuses de diámetro máximo 1600mm y máxima anchura 780mm. El mandril auto-entrante bloquea llantas de canal o de arillo desde 14" hasta 26"</p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 104054</h3>
                                </div>
                          ...
                          <ul class="nav nav-tabs ">
                            ...
                            <div class="tab-content">
                             ...
                             <!--            <tr>
                                        ...
                                        <tr>
                                            <td>Anchura máx rueda</td>
                                            <td>780mm</td>
                                        </tr>
                                        <tr>
                                           <td>Diámetro máx rueda</td>
                                            <td>1600mm </td>
                                        </tr>
                                        <tr>
                                            <td>Alimentación </td>
