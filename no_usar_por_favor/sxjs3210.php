                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/elevadoras/104143.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/elevadoras/104143.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=104143">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">elevador tijera frenos sxjs3210 </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10">1. La altura mínima es de solo 110 mm, adecuada para instalación en tierra</p><p>
2. La longitud de la plataforma principal es 1500 mm, extendida hasta 2080 mm.</p><p>
3. Sellos hidráulicos importados, todo el sistema es confiable; brazos de tijera utilizan acero internacional estándar sólido Q345, deformación permanente.</p><p>
4. La altura máxima es de 1000 mm, el estante dedicado dedicado opcional, satisface las diferentes necesidades del cliente
 .</p><p>
Diseñado especialmente adecuado para servicio rápido de neumáticos y reparación rápida de vehículos</p><p>
El diseño de protección para los pies y el control de voltaje de 24 V, proporcionan una protección integral</p><p>
El diseño general es muy adecuado para el reemplazo rápido de neumáticos y aceite de motor.
                                    ...
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 104143</h3>
