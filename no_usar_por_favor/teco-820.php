                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/alineadoras/105221.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/alineadoras/105221.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=105221">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Alineadora TECO 820 3D  </a></h2>
                                    ...
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105221</h3>
                                </div>
