...
var Autocare = function(){
	...
	var homeSearch = function() {
		...
		quikSearch.on('click',function() {
			...
			jQuery('.dlab-quik-search').delay(500).css({'right': '0'  });
		});
		
		quikSearchRemove.on('click',function() {
			jQuery('.dlab-quik-search').animate({'width': '0%' ,  'left': '0'  });
			jQuery('.dlab-quik-search').css({'right': 'auto'  });
		});	
	...
	var dzTheme = function(){
		...
		if(screenWidth < 991)
		{
			if($('.mo-left .header-nav').children('div').length == 0){
				...
				jQuery('.mo-left .header-nav .logo-header > a > img').attr('src','images/2.0/logo_neumaequipos.png');
	...
	var handleSupport = function(){
		var support = '<!-- Go to www.addthis.com/dashboard to customize your tools --><script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5d23bbe2e487c8c9"></script>';
