                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/desmontadoras/105474.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/desmontadoras/105474.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=105474">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Desmontadora Auto / Camioneta PL-1211 </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">
                                    	La desmontadora con brazo auxiliar es ideal para llantas perfil bajo o neumáticos run flat y adecuado para automóviles y camionetas. </p><p align="justify"> El brazo 098 (montado en el lado derecho) realiza casi las mismas funciones que los brazos dobles.
 </p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105474</h3>
                                </div>
