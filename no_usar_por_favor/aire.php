                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
						<div class="text-center m-b50">
							<h2 class="m-t0">Aire Acondicionado</h2>
              <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
						...
						<div class="row" id="masonry">
							<div class="col-lg-3 col-md-6 col-sm-6 m-b30 product-item card-container">
								<div class="dlab-box ">
									<div class="dlab-thum-bx  dlab-img-effect agotado"> <img src="images/2.0/aire/105454.png" alt="">
									</div>
									<div class="dlab-info p-a20 text-center">
										<h4 class="dlab-title m-t0 text-uppercase"><a href="#">EQUIPO AIRE ACONDICIONADO AC626</a></h4>
										<div class="m-t20">
											<a href="ac626.php" class="site-button">Más Info</a>
										</div>
									</div>
								</div>
							</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h3 class="label label-default">Aire Acondicionado</h3>
                <h3 class="label label-default">Aire</h3>
