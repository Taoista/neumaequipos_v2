                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/elevadoras/104026.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/elevadoras/104026.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=104026">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Elevador tijera inspección (sobre suelo) SXJS3019 </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">Elevador electro hidráulico tipo tijera para alineación, cuenta con una segunda plataforma de elevación dentro de la plataforma central la cual permite realizar trabajos de cambio de neumáticos, frenos, etc., al no contar con Jack central mejora la prestancia de trabajos a realizar como mecánica más dura, puede ir sobre suelo o bajo suelo con obra civil adecuada.</p><p align="justify">Elevador electro hidráulico sobre piso para trabajos de inspección o mecánica en general, ideal para talleres con poco espacio y altura.
 </p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 104026</h3>
                                </div>
