                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/desmontadoras/104051.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/desmontadoras/104051.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=104051">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Desmontadora TECO 55 </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">
                                    	Desmontadora electro-hidráulica para ruedas con y sin cámara de aire de camiones y autobuses de diámetro máximo 2300mm y máxima anchura 1065mm. El mandril auto-entrante bloquea llantas de canal o de arillo desde 14" hasta 46".
 </p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 104051</h3>
                                </div>
