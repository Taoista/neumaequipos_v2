                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/elevadoras/105275.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/elevadoras/105275.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=105275">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Elevador 2 columnas superior PL-4.0-2A   </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">Liberación manual desde un lado, simplemente opere la manija en el lado de la columna principal para liberar el bloqueo de seguridad.
Equipe el interruptor de límite de altura para garantizar la altura de elevación de manera segura, evitando que se dañe el techo del vehículo.
 </p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105275</h3>
                                </div>
