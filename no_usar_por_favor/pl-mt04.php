                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/elevadoras/105101.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/elevadoras/105101.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=105101">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Elevador Motociletas PL-MT04</a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p align="justify">Con una de 1000 libras. capacidad de elevación, la plataforma de elevación de motocicletas PL-MT04 brinda facilidad profesional para cualquier trabajo de servicio de motocicletas o vehículos todo terreno.</p><p align="justify">

1) Este es un elevador de motocicleta ideal para un servicio rápido. Disponible para uso en interiores o exteriores con capacidad de elevación de 452 KG. </p><p align="justify">
2) Altura mínima de 180 mm, altura máxima de 780 mm. </p><p align="justify">
3) Fácil elevación con pedal. </p><p align="justify">
4) Abrazadera de rueda delantera equipada.</p><p align="justify">
		                     <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105101</h3>
                                </div>
                         ...
                         <ul class="nav nav-tabs ">
                            ...
                            <div class="tab-content">
                             ...
                             <!--            <tr>
                                        ...
                                        <tr>
                                            <td>Altura de la plataforma</td>
                                            <td>780mm</td>
                                        </tr>
                                        <tr>
                                            <td>Poder del motor</td>
                                            <td>0.75kw</td>
                                        </tr>
                                        <tr>
                                            <td>Fuente de alimentación</td>
                                            <td>110v / 220v / 230v / 240v (1ph)</td>
                                        </tr>
