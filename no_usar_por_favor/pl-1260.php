                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/desmontadoras/105417.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/desmontadoras/105417.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=105417">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Desmontadora PL-1260 </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10">
                                    	Capacidad aro interno 22", Capacidad aro externo 12", Diámetro Máximo 41", Ancho Neumático 14", Fuerza destalonador 2500kg, Alimentación Eléctrica 220 v, Presión de servicio 8-10 bar, Velocidad de rotación 8Rpm, Peso del equipo 210kg.
 </p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105417</h3>
                                </div>
