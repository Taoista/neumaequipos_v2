                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/elevadoras/104773.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/elevadoras/104773.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=104773">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Elevador tijera alineación sxjs4021 4.3M </a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10">ELEVADOR TIJERA ALINEACIÓN</p><p>
                                        MARCA : SUNSHINE(CHINA)</p><p>
                                        MODELO : SXJS4021</p><p>
                                        CAPACIDAD ELEVACIÓN : 4.000 KG (4 TON)</p><p>
                                        ALTURA MÁX. ELEVACIÓN : 1.730/2100MM C/JACK</p><p>
                                        ANCHO TOTAL : 2100MM</p><p>
                                        PLATAFORMA ANCHO/LARGO : 600 MM/4500MM</p><p>
                                        TIEMPO DE ELEVACIÓN : 80 SEG. AJUSTABLE</p><p>
                                        FUENTE DE ALIMENTACIÓN VOLTAJE : 220V / 1 FASE /2.2KW
                                        PESO BRUTO : 2000 KG.
                                    ...
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 104773</h3>
                                </div>
