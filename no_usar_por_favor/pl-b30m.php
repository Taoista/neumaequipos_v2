                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1">
                                                <img src="images/2.0/elevadoras/105447.png" alt="">
                                                <div class="overlay-bx ">
                                                    <div class="overlay-icon ">
                                                        <a class="mfp-link" title="Product Name" href="images/2.0/elevadoras/105447.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=105447">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#"> Elevador Tijera Portátil PL-B30M PULI</a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">Este es un elevador de tijera portátil montado en superficie con capacidad de elevación de 3000 kg.  </p><p align="justify">Doble seguridad al estar equipado con bloqueo hidráulico y bloqueo mecánico de doble engranaje con garra de seguridad. </p><p align="justify">
Este elevador de tijera de altura completa PULI también es perfecto para aquellos talleres de servicio que desean evitar el aspecto abarrotado de docenas de columnas de elevadores verticales. </p>


                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105447</h3>
                                </div>
