                ...
                <div class="row m-b30">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=105449">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Desmontadora camión PL-2890 380v.</a></h2>
                                    ...
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 105449</h3>
                                </div>
