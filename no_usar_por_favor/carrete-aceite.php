                ...
                <div class="row m-b30">
                                    ...
                                    <div class="mfp-gallery">
                                        <div class="dlab-box">
                                            <div class="dlab-thum-bx dlab-img-overlay1 ">
                                                <img src="images/2.0/red/104239.png" alt="">
                                                <div class="overlay-bx">
                                                    <div class="overlay-icon">
                                                        <a class="mfp-link" title="Red Lubricación" href="images/2.0/red/104239.png">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="sticky-top">
                            <form method="post" class="cart" action="contacto.php?dato=104239">
                                <div class="dlab-post-title ">
                                    <h2 class="post-title"><a href="#">Carrete cerrado suministro aceite mod. IRE2104</a></h2>
                                    <h5 style="color:red;">Cliente es responsable de contar con grúa para recibir carga </h5>
                                    <p class="m-b10" align="justify">
                                    *Procedencia Chino </p><p align="justify">*Procedencia Chino </p><p align="justify">**Largo manguera 10 MTS. </p><p align="justify">**Entrada 1/2" . </p><p align="justify">*Presion 2.000 psi o 138 bar</p>
                                    <div class="dlab-divider bg-gray tb15"><i class="icon-dot c-square"></i></div>
                                </div>
                                    <div class="relative">
                                    <h3 class="m-tb10">Código 104239</h3>
                                </div>
