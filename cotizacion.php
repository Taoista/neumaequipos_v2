                ...
                <div class="col-lg-6 col-md-12">
                   <div class="contact_message content">
                        ...
                        <ul>
                            ...
                            <li style="font-size:15px;"><i class="fa fa-envelope-o"></i> <a href="#">contacto@neumaequipos.cl</a></li>
                            <li style="font-size:15px;"><i class="fa fa-phone"></i><a href="tel:56959120748">+56 9 5912 0748 </a> </li>
                        </ul>             
                    </div> 
                </div>
                <div class="col-lg-6 col-md-12">
